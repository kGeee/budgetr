...
import { setIncludePending } from "@/lib/pending";
...
/**
 * Count (or stop counting) pending transactions toward spending. Revalidates the
 * whole app because the flag is read inside nearly every spend query.
 */
